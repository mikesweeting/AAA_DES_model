################################################################################
# SWAN main file, women 30years reference model: sampled model
################################################################################
require(parallel) 
...
# Analysis. 
cat("##### SWAN women 30years reference model: sampled model", date(), "(runIdentifier=", runIdentifier, ")",sep=" ")
...
if (saveOutput) saveMainAndPsaObjects(processPersonsObjectsToSave, 
			...
			extraText="SWAN_women_30years_reference_model_sampled_model")
